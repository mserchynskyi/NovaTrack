...
export function AccountsModal({ isOpen, onClose, accounts, onSave, initialTab = 'profile' }: AccountsModalProps) {
  ...
  return createPortal(
    ...
    >
      <div 
        className="bg-[var(--bg-main)] h-[100dvh] sm:h-[85vh] sm:max-h-[600px] rounded-none sm:rounded-2xl shadow-2xl w-full max-w-md overflow-hidden border-none sm:border border-[var(--border-color)] flex flex-col pt-safe pb-safe sm:pt-0 sm:pb-0"
