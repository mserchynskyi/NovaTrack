...
export function SubscriptionModal({ isOpen, onClose }: SubscriptionModalProps) {
  ...
  return createPortal(
    ...
    >
      <div 
        className="bg-[var(--bg-main)] h-[100dvh] sm:h-auto sm:max-h-[85vh] rounded-none sm:rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden border-none sm:border border-[var(--border-color)] flex flex-col pt-safe sm:pt-0"
