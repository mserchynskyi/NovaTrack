...
export function SubscriptionModal({ isOpen, onClose }: SubscriptionModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 lg:bg-black/60 lg:backdrop-blur-sm z-[60] flex items-center justify-center p-0 sm:p-4">
      <div className="bg-[var(--bg-main)] h-[100dvh] sm:h-auto sm:max-h-[600px] rounded-none sm:rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden border-none sm:border border-[var(--border-color)] lg:border-none flex flex-col">
